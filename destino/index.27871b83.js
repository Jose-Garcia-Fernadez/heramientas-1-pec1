...
})({"jdXZ9":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "5c3cf7e1285358ec";
module.bundle.HMR_BUNDLE_ID = "72021ec727871b83";
"use strict";
...
function mostrarPosicionPuntero(e) {
    ...
    let ss = "w=" + document.documentElement.clientWidth + " " + (document.all ? event.x : e.pageX) + " " + document.documentElement.clientWidth + "  " + (document.all ? event.y : e.pageY) + " " + document.documentElement.clientHeight;
    if (s.indexOf("localhost") >= 0) document.title = ss;
    else document.getElementById("debug").innerHTML = ss; // Modo web al la hora de entregar practica $debug =none y no se vera 
}
...
},{}]},["jdXZ9","4awaj"], "4awaj", "parcelRequire3c64")

//# sourceMappingURL=index.27871b83.js.map
